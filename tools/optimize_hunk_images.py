...
Usage: python tools/optimize_hunk_images.py ../silicon_valley_hunk
The Hunk CLI embeds file contents in JSON, so allow for base64 overhead.
"""
import argparse
